  ...
  render() {
    ...
    const content = (
      <div className="des-header-user-detail-box">
        ...
        <div className="des-content-block-u_d-small">
          状态：<span className="des-text-success">正常</span>
        </div>
    ...
    return (
      <div className="des-header-container">
        ...
        <div className="des-header-right-menu-box">
          <Link className="des-header-menu-item" to="/console/home">
            管理控制台
          </Link>
            ...
            <span className="des-header-user">
              <Link to="/member/home">
                <Avatar
                  ...
                  icon="user"
                  src="http://docs.cq-tct.com/94H58PICREX_1024.jpg?imageView2/1/w/100/h/100"
                />
    ...
    return (
      <div className="des-float-left des-content-block-l_r-default">
        <span onClick={this.showModal} className="des-cursor">
          ...
          <span className="des-text-gray">{this.state.modalName}</span>
        </span>
        <Modal
    ...
    const content = (
      <Row className="des-change-project-container">
        ...
        {_.map(projects, (item1, key1) => {
          return (
            <div key={key1}>
              <Col span={24} className="des-sub-title">
                {key1}
              </Col>
              {_.map(item1, (item2, key2) => {
                return (
                  <Col
                    key={key2}
                    span={12}
                    style={{ margin: "3px auto", fontSize: 12 }}
                  >
        ...
        {_.map(departments, (item1, key1) => {
          return (
            ...
            >
              <a title={item1.name}>
                {item1.name}
                <span className="des-text-gray">（{item1.department}）</span>
              </a>
            </Col>
          );
        })}
