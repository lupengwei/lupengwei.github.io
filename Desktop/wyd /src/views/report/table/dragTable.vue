<template>
  <div class="container">
    <div class="button-group">
      <el-button type="primary" icon="edit" @click="dialogFormVisible = true">添加gg一条月表记录</el-button>
    ...
    <upload-excel @on-selected-file='selected'></upload-excel>
     ...
     <el-button style="margin-top:30px;float:right;"  type="primary" @click="open2">点击上传导入数据</el-button>
...
export default {
  ...
  methods: {
     selected(data) {
      ...
      axios
        .post("maintain_schedules/batch_create", {
          facilities: tempArr
