<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :data="tableData" border  height="1400px"highlight-current-row style="width: 100%;margin-top:20px;">
    ...
    <el-table :key='tableKey'height="300" :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row style="width: 100%">
