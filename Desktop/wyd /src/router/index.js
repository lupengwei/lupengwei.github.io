...
export const asyncRouterMap = [
  {
    ...
    icon: 'lock',
    meta: { role: ['admin'] },
    children: [{ path: 'index', component: _import('permission/index'), name: '测试页', meta: { role: ['admin'] }}]
  },
  {
    path: '/example',
    component: Layout,
  ...
  //     {
  //       path: '/report',
  //       component: _import('report/table/index'),
  //       redirect: '/report/table/table',
  //       name: '信息录入',
  //       icon: 'table',
  //       children: [
  //         // { path: 'dynamictable', component: _import('report/table/dynamictable/index'), name: '年表录入' },
  //         { path: 'countto', component: _import('components/countTo'), name: '变更记录' },
  //         { path: 'dragtable', component: _import('report/table/dragTable'), name: '月表录入' }  
  //             ]
  //     },
  //     { path: 'markdown', component: _import('components/markdown'), name: '维修计划编制' },
  //     // { path: 'index', component: _import('clipboard/index'), name: '' },
  //     { path: 'splitpane', component: _import('components/splitpane'), name: ' 变更记录' },
  //     { path: 'avatarupload', component: _import('components/avatarUpload'), name: ' 行监控稿' }
  //   ]
  // },
  ...
  
  {
    ...
    children: [
      ...
      // { path: 'form/create', icon: 'form', component: _import('message/form'), name: '创建Form' },
