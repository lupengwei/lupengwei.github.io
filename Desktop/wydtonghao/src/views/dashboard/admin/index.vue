	...
	<div class="dashboard-editor-container">
		...
		<el-row class="btn-group">
			...
			<el-col :span="6" class='text-center'>
				<router-link class="pan-btn light-blue-btn" to="/charts/index">维修计划</router-link>
			</el-col>
			<el-col :span="6" class='text-center'>
				<router-link class="pan-btn pink-btn" to="/excel/download">设备数据</router-link>
			</el-col>
			<el-col :span="6" class='text-center'>
				<router-link class="pan-btn green-btn" to="/excel/uploadExcel">派班中心</router-link>
			</el-col>
			<el-col :span="6" class='text-center'>
				<router-link class="pan-btn tiffany-btn" to="/example/form/edit">个人中心</router-link>
			</el-col>
