  ...
  <div class="container">
    <div class="button-group">
      <el-button type="primary" icon="edit" @click="dialogFormVisible = true">添加一条男男女女月表记录</el-button>
    ...
    <el-button style="margin-top:30px;float:right;" :loading="loading" type="primary" @click="open2">点击上传创建信息</el-button>
